...
<head>
    ...
    <link rel="stylesheet" href="assets/css/estilosTp2Ej3_A.css">
</head>
<body class="d-flex justify-content-center align-items-center vh-100 bg-dark">
    <form action="action/accion.php" method="post" class="bg-white pt-4 pb-5 px-4 rounded-2" id="formulario">
    ...
    <script src="javascript/validarTp2Ej3a.js"></script>
</body>
</html>